...
| [[projects/company-assistant-dry-run-scenarios]] | company-assistant-ops를 실제로 운영하기 전에 검증할 수 있도록 일정, follow-up, 보고 흐름의 dry-run 시나리오를 정의한 문서. | project | active |
| [[projects/company-assistant-ops-internal-structure]] | 회사 Gmail, Calendar, Sheets와 follow-up 실행을 다루는 company-assistant-ops 저장소의 내부 구조, approval, audit, handoff 규칙을 정의한 문서. | project | active |
...
| [[projects/planning-lane-execution-draft]] | 기획, 디렉팅, PT 구조, 실행 계획을 다루는 Planning Lane의 실행 흐름과 독립 agent 분리 기준을 정리한 초안. | project | draft |
| [[projects/repo-structure-refactor]] |  | project | active |
| [[projects/shared-agent-harness-executable-review-gate]] | shared-agent-harness의 executable surface를 어디까지 허용하고 어떤 변경을 escalate해야 하는지 고정한 검토 게이트 문서. | project | active |
| [[projects/shared-agent-harness-executable-surface-phase1]] | shared-agent-harness를 reference repository에서 최소 executable surface로 전환한 1차 범위와 제약을 정리한 문서. | project | active |
| [[projects/shared-agent-harness-internal-structure]] | 개인/회사 도메인에서 공용으로 재사용할 role, lane, skill, workflow를 담는 shared-agent-harness 저장소의 내부 구조 설계. | project | active |
| [[projects/shared-agent-harness-migration-list]] | shared-agent-harness 저장소 생성 후 ai-survival-log/wiki/projects 에서 옮길 설계 문서 후보와 이주 우선순위를 정리한 목록. | project | active |
| [[projects/shared-harness-executable-surface-review-2026-04-25]] | shared-agent-harness executable surface 1차 전환 이후 스크립트와 문서의 경계 일치 여부를 검토한 기록. | project | active |
