...
Graphify를 만나게 된 건 [[entities/obsidian-web-clipper|Obsidian Web Clipper]] 세팅을 마친 직후였다.

이날 [[topics/claude-plan-codex-validate|저장소 구조를 4계층으로 정리]]한 다음, 수집 파이프라인을 붙이기로 했다. 자료가 `raw/`로 들어오는 경로를 명확히 하는 게 목표였다. 템플릿 10종을 설계해서 Obsidian Web Clipper에 등록했다.
...
- [[entities/graphify]]
- [[concepts/tool-evaluation-methodology]]
