...
status: active
published: true
slug: "agent-harness-notes-02-detached-workspace"
...
# Agent Harness Notes 02 — 왜 shared-agent-harness를 떼고, 5개 프로젝트 구조로 갔는가
...
- [[projects/agent-harness-notes-series-handoff]] — 01/02 현재 상태와 다음 작업 재개 지점
- [[topics/agent-harness-notes-01-dual-domain]] — 왜 개인/회사 이중 도메인 하네스를 설계하게 됐는가
- [[projects/detached-workspace-repo-migration-review-and-plan]] — detached workspace migration 전체 검토와 단계별 계획
- [[projects/shared-agent-harness-internal-structure]] — shared-agent-harness 내부 구조 설계
- [[projects/company-wiki-internal-structure]] — company-wiki 내부 구조 설계
- [[projects/company-assistant-ops-internal-structure]] — company-assistant-ops 내부 구조 설계
