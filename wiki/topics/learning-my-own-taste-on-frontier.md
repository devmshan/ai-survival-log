...
status: active
published: true
slug: "learning-my-own-taste-on-frontier"
...
이 방향은 내가 이미 쌓고 있는 감각 위에 올라간다. 지금 내 workspace에서 해오던 개인·회사 도메인 분리, brain-hand decoupling, 경계 설계가 그대로 제품 자산이 된다. 별도 사업 아이디어 문서로 따로 정리해 두기는 했지만([[projects/executive-assistant-harness-business-idea]]), 이 글의 초점은 "왜 이 길이 나에게 가까운가"다.
...
이 감각을 [[topics/professors-brain-02-relearning-llm|02편]]에서 정리한 LLM 구조와 맞대어 보면 이상하게 맞아떨어진다.
...
- [[topics/professors-brain-02-relearning-llm]] — tokenizer에서 KV cache까지, LM head와 파라미터 정의를 잡아둔 02편
- [[topics/professors-brain-03-closing-the-loop]] — Claude Design과 AI for Science, 두 번째 도망길의 루프 구조
- [[topics/agent-harness-notes-01-dual-domain]] — 개인/회사 이중 도메인 하네스 설계기, 첫 번째 도망길의 운영 감각
- [[projects/executive-assistant-harness-business-idea]] — 경영진 전용 비서 Agent 하네스 사업 아이디어
- [[concepts/ai-capability-overhang]]
